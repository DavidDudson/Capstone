...
public class ChineseCheckerGameSupport extends DefaultGameSupport {

	public ChineseCheckerGameSupport() {
		super("Gomoku");
	}
	...
	public Collection<Class<?>> getWhitelistedClasses() {
		...
		clazzes.add(EasyChineseCheckerBoard.class);
		clazzes.add(ChineseCheckerBot.class);
		clazzes.add(ChineseCheckerPosition.class);		
		return clazzes;
	}
	...
	public GameFactory getGameFactory() {
		return new GameFactory() {
			...
			public Game<?, ?> createGame(String id, Bot<?, ?> player1, Bot<?, ?> player2) {
				return new ChineseCheckerGame(id, player1, player2);
			}
		};
	}
	...
	public Serializer getSerializer() {
		return new ChineseCheckerSerializer();
	}
