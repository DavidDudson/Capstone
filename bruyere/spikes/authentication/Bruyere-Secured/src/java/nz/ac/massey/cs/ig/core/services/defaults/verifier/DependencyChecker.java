package nz.ac.massey.cs.ig.core.services.defaults.verifier;

import nz.ac.massey.cs.ig.core.services.BuildProblemCollector;
import nz.ac.massey.cs.ig.core.services.defaults.AbstractByteCodeVerifier;
...
public class DependencyChecker extends ClassVisitor {
    ...
    private void checkTypeAccess(String type) throws SecurityException {
        if (!type.equals(thisClass)) {
            verifier.checkAccessToType(type,dLog,lineNo);
        }
    }
