...
<html>
    <head>
        ...
        <script src="/Bruyere-Secured/pages/js/jquery-1.10.2.min.js"></script>
        <script src="/Bruyere-Secured/pages/js/bootstrap.min.js"></script>
        <link href="/Bruyere-Secured/pages/css/bootstrap.css" rel="stylesheet">
        <link href='/Bruyere-Secured/pages/css/bruyere.css' rel='stylesheet' type='text/css'/>
        <script src="/Bruyere-Secured/pages/js/authMethod.js"></script>        
        ...
        <script src="/Bruyere-Secured/pages/js/hello.min.js"></script>
    </head>
