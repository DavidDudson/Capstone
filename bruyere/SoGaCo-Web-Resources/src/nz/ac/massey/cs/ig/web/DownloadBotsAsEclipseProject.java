...
public class DownloadBotsAsEclipseProject extends BasicBruyereServlet {
	...
	public static final String BUILTIN_BOTS_USER = Configuration.BUILTIN_BOTS_PSEUDO_USER;
	...
	protected void doGet(HttpServletRequest request,
		...
		for (BotData data : datas) {
			// skip all other bots except for now
			if(!data.getLanguage().contains(JavaSupport.IDENTIFIER)) {
				continue;
			}
			...
			try {
				className = new SourceUtils().extractClassName(data.getName(), data.getSrc());
