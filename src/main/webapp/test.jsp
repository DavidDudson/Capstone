            ...
            <div id="game_controls" class="sidebar_box">
                <div class="right-inner">
                    ...
                    <div class="sidebar_content">
                        <div id="controls">
                            <div class="btn-group">
                                <button type="button" ng-click="game.start()" class="btn btn-primary">
                                    <i class="fa fa-fast-backward"></i></button>
                                <button type="button" ng-click="game.stepBack()" class="btn btn-primary">
                                    <i class="fa fa-step-backward"></i></button>
                                <button type="button" ng-click="game.playPause()" class="btn btn-primary">
                                    <i class="fa" ng-class="game.inProgress ? 'fa-play' : 'fa-pause'"></i>
                                </button>
                                <button type="button" ng-click="game.stepForward()" class="btn btn-primary">
