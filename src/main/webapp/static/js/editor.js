angular
    ...
    .controller("editorCtrl", function ($http, $rootScope) {
        ...
        $rootScope.editor = {
            ...
            initialize: function () {
                var workspace = Blockly.inject('blocklyDiv', $rootScope.blocklyConfig);
                ...
                Blockly.Xml.domToWorkspace(workspace, angular.element('#initialBlocklyState'));
            ...
            toggleBlockly: function () {
                $rootScope.editor.showBlockly = !$rootScope.editor.showBlockly
            }
