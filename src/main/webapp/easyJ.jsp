...
<head>
    ...
    <script type="text/javascript" src="static/js/EasyJ/blockly_compressed.js"></script>
    ...
    <script type="text/javascript" src="static/js/EasyJ/custCode.js"></script>
    ...
    <script type="text/javascript">
        ...
        function toCode() {
            ...
            output.value = codeHeader()+ Blockly['Java'].workspaceToCode() + codeFooter();
        }
